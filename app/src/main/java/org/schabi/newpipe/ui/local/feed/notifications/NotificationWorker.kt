...
import org.schabi.newpipe.ui.local.feed.service.FeedLoadManager
...
class NotificationWorker(appContext: Context, workerParams: WorkerParameters) : RxWorker(appContext, workerParams) {
    ...
    companion object {
        ...
        private fun areNotificationsEnabled(context: Context) =
            NotificationHelper.areNewStreamsNotificationsEnabled(context) && NotificationHelper.areNotificationsEnabledOnDevice(
                context)
