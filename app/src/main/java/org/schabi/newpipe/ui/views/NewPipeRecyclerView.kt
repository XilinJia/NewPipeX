...
class NewPipeRecyclerView : RecyclerView {
    ...
    private val tempFocus = Rect()

    private var allowDpadScroll = true
    ...
    private fun tryFocusFinder(direction: Int): Boolean {
        ...
        val focusFinderResult = finder.findNextFocusFromRect(root, tempFocus, direction)
        ...
        while (parent !== root) {
            ...
            val candidate = finder.findNextFocusFromRect(parent, tempFocus, direction)
    ...
    companion object {
        private const val TAG = "NewPipeRecyclerView"
    }
}
