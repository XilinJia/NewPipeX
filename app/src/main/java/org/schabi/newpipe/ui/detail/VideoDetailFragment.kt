...
import org.schabi.newpipe.ui.fragments.EmptyFragment.Companion.newInstance
import org.schabi.newpipe.ui.fragments.MainFragment
import org.schabi.newpipe.ui.list.BaseListInfoFragment
import org.schabi.newpipe.ui.list.RelatedItemsFragment
...
//                    ACTION_HIDE_MAIN_PLAYER -> bottomSheetBehavior!!.setState(BottomSheetBehavior.STATE_HIDDEN)
    ...
    internal class StackItem(@JvmField val serviceId: Int, @JvmField var url: String, @JvmField var title: String, @JvmField var playQueue: PlayQueue) : Serializable {
