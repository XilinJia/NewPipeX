...
import org.schabi.newpipe.ui.local.subscription.dialog.FeedGroupDialog.ScreenState.DeleteScreen
import org.schabi.newpipe.ui.local.subscription.dialog.FeedGroupDialog.ScreenState.IconPickerScreen
import org.schabi.newpipe.ui.local.subscription.dialog.FeedGroupDialog.ScreenState.InitialScreen
import org.schabi.newpipe.ui.local.subscription.dialog.FeedGroupDialog.ScreenState.SubscriptionsPickerScreen
import org.schabi.newpipe.ui.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.ProcessingEvent
import org.schabi.newpipe.ui.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.SuccessEvent
import org.schabi.newpipe.ui.local.subscription.item.ImportSubscriptionsHintPlaceholderItem
import org.schabi.newpipe.ui.local.subscription.item.PickerSubscriptionItem
...
class FeedGroupDialog : DialogFragment(), BackPressable {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this,
            FeedGroupDialogViewModel.getFactory(requireContext(),
                groupId,
        ...
        if (currentScreen == SubscriptionsPickerScreen && wasSearchSubscriptionsVisible) showSearch()
        else if (currentScreen == InitialScreen && groupId == NO_GROUP_SELECTED) showKeyboard()
    }
