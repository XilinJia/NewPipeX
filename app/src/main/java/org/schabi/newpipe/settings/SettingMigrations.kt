    ...
    private val MIGRATION_4_5: Migration = object : Migration(4, 5) {
        override fun migrate(context: Context) {
            ...
            editor.putString(context.getString(R.string.right_gesture_control_key),
                context.getString(if (volume
                ) R.string.volume_control_key else R.string.none_control_key))
            editor.putString(context.getString(R.string.left_gesture_control_key),
                context.getString(if (brightness
                ) R.string.brightness_control_key else R.string.none_control_key))
        ...
        override fun migrate(context: Context) {
            ...
            sp!!.edit()
                .putString(context.getString(R.string.image_quality_key),
                    context.getString(if (loadImages
                    ) R.string.image_quality_default
                    else R.string.image_quality_none_key))
                .apply()
        }
    }
