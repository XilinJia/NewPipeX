...
abstract class SubscriptionDAO : BasicDAO<SubscriptionEntity> {
    ...
    abstract fun getSubscriptionsOnlyUngrouped(currentGroupId: Long): Flowable<List<SubscriptionEntity>>
    ...
    open fun upsertAll(entities: List<SubscriptionEntity>): List<SubscriptionEntity> {
        ...
        insertUidList.forEachIndexed { index: Int, uidFromInsert: Long ->
            ...
            if (uidFromInsert != -1L) {
                ...
                val subscriptionIdFromDb =
                    getSubscriptionIdInternal(entity.serviceId, entity.url)
