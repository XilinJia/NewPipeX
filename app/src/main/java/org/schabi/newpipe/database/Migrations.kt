...
object Migrations {
    ...
    /////////////////////////////////////////////////////////////////////////////
    const val DB_VER_1: Int = 1
    const val DB_VER_2: Int = 2
    const val DB_VER_3: Int = 3
    const val DB_VER_4: Int = 4
    const val DB_VER_5: Int = 5
    const val DB_VER_6: Int = 6
    const val DB_VER_7: Int = 7

    private val TAG: String = Migrations::class.java.name
