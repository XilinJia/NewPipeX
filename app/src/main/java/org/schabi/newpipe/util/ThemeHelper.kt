...
object ThemeHelper {
    ...
    fun isLightThemeSelected(context: Context): Boolean {
        ...
        return selectedThemeKey == res.getString(R.string.light_theme_key) || (selectedThemeKey == res.getString(R.string.auto_device_theme_key) && !isDeviceDarkThemeEnabled(
            context))
    }
    ...
    fun getMinWidthDialogTheme(context: Context): Int {
        return if (isLightThemeSelected(context)) R.style.LightDialogMinWidthTheme
        else R.style.DarkDialogMinWidthTheme
    }
    ...
    fun getSettingsThemeStyle(context: Context): Int {
        ...
        if (selectedTheme == lightTheme) {
            ...
            if (isDeviceDarkThemeEnabled(context)) {
                ...
                return if (selectedNightTheme == blackTheme) {
    ...
    fun getItemViewMode(context: Context): ItemViewMode {
        ...
        if (listMode == context.getString(R.string.list_view_mode_list_key)) {
