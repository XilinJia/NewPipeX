...
object DeviceUtils {
     ...
     */
    const val MEDIA_TUNNELING_DEVICE_BLACKLIST_VERSION: Int = 994
 ...
 * #10122](https://github.com/TeamNewPipe/NewPipe/pull/10122#issuecomment-1638475769)
    ...
    val isFireTv: Boolean
        get() {
            ...
            isFireTV =
                App.getApp().packageManager.hasSystemFeature(AMAZON_FEATURE_FIRE_TV)
            return isFireTV!!
        }
    ...
    fun isTv(context: Context): Boolean {
        ...
        val pm = App.getApp().packageManager
    ...
    fun isDesktopMode(context: Context): Boolean {
        ...
        val uiModeManager =
            ContextCompat.getSystemService(context, UiModeManager::class.java)
        ...
        try {
            ...
            val semDesktopModeEnabledConst =
