...
class ImageStrategyTest {
    ...
    fun testChoosePreferredImageAllKnown() {
        ...
        assertChoosePreferredImage("a", "b", "c", listOf(
        ...
        assertChoosePreferredImage("b", "c", "d", listOf(
        ...
        assertChoosePreferredImage("c", "d", "d", listOf(
    ...
    fun testChoosePreferredImageMixed() {
        for (resolutionLevel in RESOLUTION_LEVELS) {
            assertChoosePreferredImage("d", "b", "c", listOf(
        ...
        for (resolutionLevel in RESOLUTION_LEVELS) {
            assertChoosePreferredImage("b", "b", "b", listOf(
                img("a", ResolutionLevel.UNKNOWN),
                img("b", 200, 100, resolutionLevel),
                img("e", resolutionLevel)
            ))
        }
        assertChoosePreferredImage("b", "b", "e", listOf(
            img("a", ResolutionLevel.UNKNOWN),
    ...
    fun testChoosePreferredImageAllUnknown() {
        ...
        assertChoosePreferredImage("c", "c", "d", listOf(
            img("a", ResolutionLevel.UNKNOWN),
            img("c", ResolutionLevel.MEDIUM),
            img("d", ResolutionLevel.HIGH)
        ))
        assertChoosePreferredImage("b", "c", "c", listOf(
            img("a", ResolutionLevel.UNKNOWN),
            img("b", ResolutionLevel.LOW),
            img("c", ResolutionLevel.MEDIUM)
        ))
        ...
        assertChoosePreferredImage("d", "d", "d", listOf(
            img("a", ResolutionLevel.UNKNOWN),
            img("d", ResolutionLevel.HIGH)
        ))
        assertChoosePreferredImage("b", "b", "b", listOf(
        ...
        assertChoosePreferredImage("a", "a", "a", listOf(
            img("a", ResolutionLevel.UNKNOWN)
        ))
    }

    companion object {
        private val RESOLUTION_LEVELS: List<ResolutionLevel> = listOf(
